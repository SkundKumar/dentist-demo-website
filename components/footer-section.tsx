      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">Glowdent Medicare</div>
          </div>
          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
            Dental & Skin Care You Can Trust — 24 Hours
          </div>

          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
            Shop No. F103, Eldeco Mystic Greens, Behind Supertech Czar, Omicron I, Greater Noida, UP 201310
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          {/* About Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5 font-sans">About</div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[180px]">
            ...
            <div className="mt-4 w-full">
              <iframe
                src="https://www.google.com/maps?q=Glowdent+Medicare,+Eldeco+Mystic+Greens,+Greater+Noida&output=embed"
                width="100%"
                height="200"
                style={{ border: 0 }}
                allowFullScreen
