...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "I had severe tooth pain at 2am and thought I'd have to wait until morning. Glowdent was there immediately. The 24/7 service is a lifesaver — professional, compassionate, and genuinely caring.",
      name: "Neha Gupta",
      company: "Emergency Patient",
      image: encodeURI('/Dental school🫶🏼🦷.jpg.jpeg'),
    },
    {
      quote:
        "Brought my 6-year-old for his first dental visit and he actually enjoyed it. The team was so patient and gentle with him. We won't go anywhere else.",
      name: "Priya Sharma",
      company: "Parent",
      image: encodeURI('/%23dentalschool %23doctor %23dentalcare %23work.jpg.jpeg'),
    },
    {
      quote:
        "I've always been terrified of the dentist. The sedation option changed everything — I was completely relaxed and the whole thing was over before I knew it. Incredible team.",
      name: "Rohan Mehta",
      company: "Sedation Patient",
      image: encodeURI('/🦷.jpg.jpeg'),
    },
  ]
