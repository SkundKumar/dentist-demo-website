        ...
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <a href="https://wa.me/919711278427?text=Hi%20Glowdent%20Medicare%2C%20I%20would%20like%20to%20book%20an%20appointment." target="_blank" rel="noopener noreferrer">
              <Button className="h-10 px-12 bg-[#25D366] hover:bg-[#20b858] text-white rounded-full font-medium text-sm shadow-none flex items-center gap-2">
                <FaWhatsapp aria-hidden className="w-4 h-4" />
                Book on WhatsApp
              </Button>
            </a>
            <a href="https://wa.me/919711278427?text=Hi%20Glowdent%20Medicare%2C%20I%20would%20like%20to%20book%20an%20appointment." target="_blank" rel="noopener noreferrer">
              <Button className="h-10 px-12 bg-white hover:bg-gray-50 text-[#37322f] border border-[#37322f]/20 rounded-full font-medium text-sm shadow-sm flex items-center gap-2">
